...
app.get('/songs', (request, response) => {
  ...
  let options = {
    ...
    "port": null,
    "path": `/search?term=${encodeURIComponent(song)}&entity=musicTrack&limit=3`,
    "headers": {
      "useQueryString": true
    }
  }
...
app.listen(PORT, err => {
  if(err) console.log(err)
    ...
    console.log(`To Test:`)
    console.log(`http://localhost:3000/songs?name=drunken sailor`)
